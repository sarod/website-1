...
##### `yarn audit [--verbose] [--json] [--level] [--group]` <a class="toc" id="toc-yarn-audit" href="#toc-yarn-audit"></a>
...
##### `yarn audit [--group group_name]` <a class="toc" id="toc-yarn-add" href="#toc-yarn-add"></a>

Applying the group flag will limit the audit table to vulnerabilities of the corresponding dependency group (e.g dependencies or devDependencies).
